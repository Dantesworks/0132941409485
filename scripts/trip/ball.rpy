label ball1:
    ...
    play music "sounds/crowd.mp3"
    scene ball1 with fade
    $ renpy.pause()
    scene ball2 with dissolve
    $ renpy.pause()
    scene ball3 with dissolve
    $ renpy.pause()
    scene ball4 with dissolve
    $ renpy.pause()
    scene ball5 with dissolve
    $ renpy.pause()
    scene ball6 with dissolve
    $ renpy.pause()
    scene ball7 with dissolve
    $ renpy.pause()
    scene ball8 with dissolve
    $ renpy.pause()
    scene ball9 with dissolve
    $ renpy.pause()
    scene ball10 with dissolve
    $ renpy.pause()
    scene ball11 with dissolve
    $ renpy.pause()
    scene ball12 with dissolve
    $ renpy.pause()
    scene ball13 with dissolve
    $ renpy.pause()
    scene ball14 with dissolve
    $ renpy.pause()
    scene ball15 with dissolve
    $ renpy.pause()
    scene ball16 with dissolve
    $ renpy.pause()
    scene ball17 with dissolve
    $ renpy.pause()
    scene ball18 with dissolve
    $ renpy.pause()
    scene ball19 with dissolve
    $ renpy.pause()
    scene ball20 with dissolve
    $ renpy.pause()
    scene ball21 with dissolve
    $ renpy.pause()
    scene ball22 with dissolve
    $ renpy.pause()
    scene ball23 with dissolve
    $ renpy.pause()
    scene ball24 with dissolve
    $ renpy.pause()
    scene ball25 with dissolve
    $ renpy.pause()
    scene ball26 with dissolve
    $ renpy.pause()
    scene ball27 with dissolve
    $ renpy.pause()
    scene ball28 with dissolve
    $ renpy.pause()
    scene ball29 with dissolve
    $ renpy.pause()
    scene ball30 with dissolve
    $ renpy.pause()
    scene ball31 with dissolve
    $ renpy.pause()
    scene ball32 with dissolve
    $ renpy.pause()
    scene ball33 with dissolve
    $ renpy.pause()
    scene ball34 with fade
    $ renpy.pause()
    scene ball35 with dissolve
    $ renpy.pause()
    scene ball36 with dissolve
    $ renpy.pause()
    scene ball37 with dissolve
    $ renpy.pause()
    scene ball38 with dissolve
    $ renpy.pause()
    scene ball206 with fade
    $ renpy.pause()
    scene ball207 with dissolve
    $ renpy.pause()
    scene ball208 with dissolve
    $ renpy.pause()
    scene ball209 with dissolve
    $ renpy.pause()
    scene ball210 with dissolve
    $ renpy.pause()
    scene ball211 with dissolve
    $ renpy.pause()
    scene ball39 with fade
    $ renpy.pause()
    scene ball40 with dissolve
    $ renpy.pause()
    scene ball41 with dissolve
    $ renpy.pause()
    scene ball42 with dissolve
    $ renpy.pause()
    scene ball43 with dissolve
    $ renpy.pause()
    scene ball44 with dissolve
    $ renpy.pause()
    scene ball45 with dissolve
    $ renpy.pause()
    scene ball46 with dissolve
    $ renpy.pause()
    scene ball47 with dissolve
    $ renpy.pause()
    scene ball48 with dissolve
    $ renpy.pause()
    scene ball49 with dissolve
    $ renpy.pause()
    scene ball50 with dissolve
    $ renpy.pause()
    scene ball51 with dissolve
    $ renpy.pause()
    scene ball52 with dissolve
    $ renpy.pause()
    scene ball53 with dissolve
    $ renpy.pause()
    scene ball54 with dissolve
    $ renpy.pause()
    scene ball55 with dissolve
    $ renpy.pause()
    scene ball56 with dissolve
    $ renpy.pause()
    scene ball57 with dissolve
    $ renpy.pause()
    scene ball58 with dissolve
    $ renpy.pause()
    scene ball59 with dissolve
    $ renpy.pause()
    scene ball60 with dissolve
    $ renpy.pause()
    scene ball61 with dissolve
    $ renpy.pause()
    scene ball62 with dissolve
    $ renpy.pause()
    scene ball63 with dissolve
    $ renpy.pause()
    scene ball64 with dissolve
    $ renpy.pause()
    scene ball65 with dissolve
    $ renpy.pause()
    scene ball66 with dissolve
    $ renpy.pause()
    scene ball67 with dissolve
    $ renpy.pause()
    scene ball68 with dissolve
    $ renpy.pause()
    scene ball69 with dissolve
    $ renpy.pause()
    scene ball70 with dissolve
    $ renpy.pause()
    scene ball71 with dissolve
    $ renpy.pause()
    scene ball72 with dissolve
    $ renpy.pause()
    scene ball73 with dissolve
    $ renpy.pause()
    scene ball74 with dissolve
    $ renpy.pause()
    scene ball75 with dissolve
    $ renpy.pause()
    scene ball76 with dissolve
    $ renpy.pause()
    scene ball77 with dissolve
    $ renpy.pause()
    scene ball78 with dissolve
    $ renpy.pause()
    scene ball79 with dissolve
    $ renpy.pause()
    scene ball80 with dissolve
    $ renpy.pause()
    scene ball81 with dissolve
    $ renpy.pause()
    scene ball82 with dissolve
    $ renpy.pause()
    scene ball83 with dissolve
    $ renpy.pause()
    scene ball84 with dissolve
    $ renpy.pause()
    scene ball85 with dissolve
    $ renpy.pause()
    scene ball86 with dissolve
    $ renpy.pause()
    scene ball87 with dissolve
    $ renpy.pause()
    scene ball88 with dissolve
    $ renpy.pause()
    scene ball89 with dissolve
    $ renpy.pause()
    scene ball90 with dissolve
    $ renpy.pause()
    scene ball91 with dissolve
    $ renpy.pause()
    scene ball92 with dissolve
    $ renpy.pause()
    scene ball93 with dissolve
    $ renpy.pause()
    scene ball94 with dissolve
    $ renpy.pause()
    scene ball95 with dissolve
    $ renpy.pause()
    scene ball96 with dissolve
    $ renpy.pause()
    scene ball97 with dissolve
    $ renpy.pause()
    scene ball98 with dissolve
    $ renpy.pause()
    scene ball99 with dissolve
    $ renpy.pause()
    scene ball100 with dissolve
    $ renpy.pause()
    scene ball101 with dissolve
    $ renpy.pause()
    scene ball102 with dissolve
    $ renpy.pause()
    scene ball103 with dissolve
    $ renpy.pause()
    scene ball104 with dissolve
    $ renpy.pause()
    scene ball105 with dissolve
    $ renpy.pause()
    scene ball106 with dissolve
    $ renpy.pause()
    scene ball107 with dissolve
    $ renpy.pause()
    scene ball108 with dissolve
    $ renpy.pause()
    scene ball109 with dissolve
    $ renpy.pause()
    scene ball110 with dissolve
    $ renpy.pause()
    scene ball111 with dissolve
    $ renpy.pause()
    scene ball112 with dissolve
    $ renpy.pause()
    scene ball113 with dissolve
    $ renpy.pause()
    scene ball114 with dissolve
    $ renpy.pause()
    scene ball115 with dissolve
    $ renpy.pause()
    scene ball212 with fade
    $ renpy.pause()
    scene ball213 with dissolve
    $ renpy.pause()
    scene ball214 with dissolve
    $ renpy.pause()
    scene ball215 with dissolve
    $ renpy.pause()
    scene ball216 with dissolve
    $ renpy.pause()
    scene ball217 with dissolve
    $ renpy.pause()
    scene ball218 with dissolve
    $ renpy.pause()
    scene ball219 with dissolve
    $ renpy.pause()
    scene ball220 with dissolve
    $ renpy.pause()
    scene ball116 with fade
    $ renpy.pause()
    scene ball117 with dissolve
    $ renpy.pause()
    scene ball118 with dissolve
    $ renpy.pause()
    scene ball119 with dissolve
    $ renpy.pause()
    scene ball120 with dissolve
    $ renpy.pause()
    scene ball121 with dissolve
    $ renpy.pause()
    scene ball122 with dissolve
    $ renpy.pause()
    scene ball123 with dissolve
    $ renpy.pause()
    scene ball124 with dissolve
    $ renpy.pause()
    scene ball125 with dissolve
    $ renpy.pause()
    scene ball126 with dissolve
    $ renpy.pause()
    scene ball127 with dissolve
    $ renpy.pause()
    scene ball128 with dissolve
    $ renpy.pause()
    scene ball129 with dissolve
    $ renpy.pause()
    scene ball130 with dissolve
    $ renpy.pause()
    scene ball131 with dissolve
    $ renpy.pause()
    scene ball132 with dissolve
    $ renpy.pause()
    scene ball133 with fade
    $ renpy.pause()
    scene ball134 with dissolve
    $ renpy.pause()
    scene ball135 with dissolve
    $ renpy.pause()
    scene ball136 with dissolve
    $ renpy.pause()
    scene ball137 with dissolve
    $ renpy.pause()
    scene ball138 with dissolve
    $ renpy.pause()
    scene ball139 with dissolve
    $ renpy.pause()
    scene ball140 with dissolve
    $ renpy.pause()
    scene ball141 with dissolve
    $ renpy.pause()
    scene ball142 with dissolve
    $ renpy.pause()
    scene ball143 with dissolve
    $ renpy.pause()
    scene ball144 with dissolve
    $ renpy.pause()
    scene ball145 with dissolve
    $ renpy.pause()
    scene ball146 with dissolve
    $ renpy.pause()
    scene ball147 with dissolve
    $ renpy.pause()
    scene ball148 with dissolve
    $ renpy.pause()
    scene ball149 with dissolve
    $ renpy.pause()
    scene ball150 with dissolve
    $ renpy.pause()
    scene ball151 with dissolve
    $ renpy.pause()
    scene ball152 with dissolve
    $ renpy.pause()
    scene ball153 with dissolve
    $ renpy.pause()
    scene ball154 with dissolve
    $ renpy.pause()
    scene ball155 with dissolve
    $ renpy.pause()
    scene ball221 with fade
    $ renpy.pause()
    scene ball222 with dissolve
    $ renpy.pause()
    scene ball223 with dissolve
    $ renpy.pause()
    scene ball224 with dissolve
    $ renpy.pause()
    scene ball225 with dissolve
    $ renpy.pause()
    scene ball226 with dissolve
    $ renpy.pause()
    scene ball227 with dissolve
    $ renpy.pause()
    scene ball228 with dissolve
    $ renpy.pause()
    scene ball229 with dissolve
    $ renpy.pause()
    scene ball230 with dissolve
    $ renpy.pause()
    scene ball231 with dissolve
    $ renpy.pause()
    scene ball232 with dissolve
    $ renpy.pause()
    scene ball233 with dissolve
    $ renpy.pause()
    scene ball234 with dissolve
    $ renpy.pause()
    scene ball235 with dissolve
    $ renpy.pause()
    scene ball236 with dissolve
    $ renpy.pause()
    scene ball156 with fade
    $ renpy.pause()
    scene ball157 with dissolve
    $ renpy.pause()
    scene ball158 with dissolve
    $ renpy.pause()
    scene ball159 with dissolve
    $ renpy.pause()
    scene ball160 with dissolve
    $ renpy.pause()
    scene ball161 with dissolve
    $ renpy.pause()
    scene ball162 with dissolve
    $ renpy.pause()
    scene ball163 with dissolve
    $ renpy.pause()
    scene ball164 with dissolve
    $ renpy.pause()
    scene ball165 with dissolve
    $ renpy.pause()
    scene ball166 with dissolve
    $ renpy.pause()
    scene ball167 with dissolve
    $ renpy.pause()
    scene ball168 with dissolve
    $ renpy.pause()
    scene ball169 with dissolve
    $ renpy.pause()
    scene ball170 with dissolve
    $ renpy.pause()
    scene ball172 with dissolve
    $ renpy.pause()
    scene ball173 with dissolve
    $ renpy.pause()
    scene ball174 with dissolve
    $ renpy.pause()
    scene ball175 with dissolve
    $ renpy.pause()
    scene ball176 with dissolve
    $ renpy.pause()
    scene ball177 with dissolve
    $ renpy.pause()
    scene ball178 with dissolve
    $ renpy.pause()
    scene ball179 with dissolve
    $ renpy.pause()
    scene ball180 with dissolve
    $ renpy.pause()
    scene ball181 with dissolve
    $ renpy.pause()
    scene ball182 with dissolve
    $ renpy.pause()
    scene ball183 with dissolve
    $ renpy.pause()
    scene ball184 with dissolve
    $ renpy.pause()
    scene ball185 with dissolve
    $ renpy.pause()
    scene ball186 with dissolve
    $ renpy.pause()
    scene ball187 with dissolve
    $ renpy.pause()
    scene ball188 with dissolve
    $ renpy.pause()
    scene ball189 with dissolve
    $ renpy.pause()
    scene ball190 with dissolve
    $ renpy.pause()
    scene ball191 with dissolve
    $ renpy.pause()
    scene ball192 with dissolve
    $ renpy.pause()
    scene ball193 with dissolve
    $ renpy.pause()
    scene ball194 with dissolve
    $ renpy.pause()
    scene ball195 with dissolve
    $ renpy.pause()
    scene ball196 with dissolve
    $ renpy.pause()
    scene ball197 with dissolve
    $ renpy.pause()
    scene ball198 with dissolve
    $ renpy.pause()
    scene ball199 with dissolve
    $ renpy.pause()
    scene ball200 with dissolve
    $ renpy.pause()
    scene ball201 with dissolve
    $ renpy.pause()
    scene ball202 with dissolve
    $ renpy.pause()
    scene ball203 with dissolve
    $ renpy.pause()
    scene ball204 with dissolve
    $ renpy.pause()
    scene ball205 with flash
    $ renpy.pause()
    ...
    scene bd6 with dissolve
    p "Hello, [p] here."
    n "It's me, your favourite girl."
    scene bd7 with dissolve
    p "Ooh, Sandy?"
    ...
    scene bd78 with dissolve
    n "This is really getting me in the mood."
    p "You free tonight?"
    scene bd79 with dissolve
    n "Of course. But we're in different rooms, aren't we?"
    p "We could always go somewhere. It's not like they don't know we fuck."
    n "That's true."
    scene bd80 with dissolve
    n "So how shall we end this? A twirl like with your [mr]?"
    p "Up to you, haha."
    scene bd81 with dissolve
    n "In that case...."
    scene bd82 with hpunch
    "Nicole pulled me up close to her, causing me to lose my footing."
    scene bd83 with dissolve
    "And pressed her lips against mine."
    p "...mmm!"
    scene bd84 with dissolve
    n "Well, all the boys watching me now know I'm taken for sure."
    p "How'd they figure?"
    scene bd85 with dissolve
    n "The kiss?"
    p "They might have missed it. We really need to be sure."
    n "Sure~?"
    p "Sure that you're my woman, not anyone else's."
    "My turn."
    scene bd86 with hpunch
    $ renpy.pause()
    # Kiss
    scene bd87 with dissolve
    $ renpy.pause()
    scene bd88 with dissolve
    $ renpy.pause()
    n "Mmm~"
    scene bd89 with dissolve
    p "Good."
    p "Woo, I need to sit back down and cool down a bit."
    scene bd90 with dissolve
    $ renpy.pause()
    scene bd91 with dissolve
    $ renpy.pause()
    scene bd92 with dissolve
    $ renpy.pause()
    scene bd93 with dissolve
    $ renpy.pause()
    n "That was spicy, wasn't it!"
    n "I lost myself for a moment there. I love a man who can surprise me."
    p "A good end to a dance, for sure."
    # back to table
    play music "sounds/cygnus.mp3" fadeout 1
    scene bd94 with fade
    ...
    scene bd115 with dissolve
    $ renpy.pause()
    # disappears
    play music "sounds/cygnus.mp3" fadeout 1
    scene bd116 with dissolve
    s "What... did he want?"
    scene bd117 with dissolve
    ...
    scene bd133 with dissolve
    s "Huh? I-I..."
    s "[p] is just my-!"
    scene bd134 with dissolve
    ...
    scene bd135 with dissolve
    s "..."
    douche "Fine!"
    scene bd136 with dissolve
    douche "You know, I bet you're really fucking ugly under all that make-up."
    scene bd137 with dissolve
    ...
    scene bd153 with dissolve
    s "I... I..."
    scene bd154 with vpunch
    p "You-!"
    douche "Whoa! Whoa!"
    menu:
        "Give him a beat down.":
            $ depravity += 1
            scene bd155 with dissolve
            p "Hey."
            douche "Huh?"
            p "Nice suit."
            douche "Thanks, I-"
            # WHAM
            scene bd157 with hpunch
            "{i}WHAM!!{/i}"
            scene bd158 with dissolve
        ...
        "Threaten him with a beat down.":
            ...
            scene bd156 with dissolve
            $ renpy.pause()
            "Jesus. I'm glad he's gone."
    stop music fadeout 1
    scene bd159 with fade
    p "That got me a little angry, sorry."
    scene bd160 with dissolve
    p "Where's Kaira?"
    scene bd161 with dissolve
    m "..."
    scene bd162 with dissolve
    ...
    scene bd166 with dissolve
    n "We'll take care of things here, [p]."
    p "You guys... thanks for everything."
    p "I'll head off."
    # Transition
    scene black with fade
    scene bd167 with fade
    play music "sounds/missingyou.ogg" fadeout 1
    $ renpy.pause()
    p "K-Kaira?"
    s "{i}Sob, sob{/i}"
    scene bd168 with dissolve
    $ renpy.pause()
    "Kaira..."
    scene bd169 with dissolve
    p "How are you going?"
    scene bd170 with dissolve
    s "[p]... why are people so... mean?"
    s "People at school make fun of me..."
    s "And-!"
    s "Even now..."
    scene bd171 with dissolve
    ...
    scene bd172 with dissolve
    s "..."
    scene bd173 with dissolve
    s "But what if he was right, [p]?"
    scene bd174 with dissolve
    s "..."
    scene bd175 with dissolve
    s "What if really... nobody likes me."
    scene bd176 with dissolve
    s "What if I'm... just like a toy to people."
    s "Just to look good for a while. But really, deep down..."
    p "Nonsense."
    scene bd177 with dissolve
    "I leapt next to her. I just wanted to hold her."
    scene bd178 with dissolve
    ...
    $ renpy.pause()
    s "Mmmm..."
    "Kaira's lips planted onto mine. It was awkward, but there was some innocence in it."
    "It wasn't tight like Nicole's. Kaira's lipstick stuck to my lips and her inexperience showed."
    "But it was cute, and I smiled."
    scene bd191 with dissolve
    s "How... was my kiss?"
    p "You're getting there."
    scene bd192 with dissolve
    s "Maybe... I need more practise."
    scene bd193 with dissolve
    $ renpy.pause()
    scene bd194 with dissolve
    $ renpy.pause()
    scene bd195 with dissolve
    s "When you said you thought of me back at the beach..."
    s "I'm still not sure what you meant by that."
    p "What do you mean?"
    s "Like..."
    scene bd196 with dissolve
    ...
    "I am both the depraved soul and the saviour."
    p "What do you want to know, Kaira?"
    scene bd198 with dissolve
    ...
    scene bd218 with dissolve
    n "..."
    p "Not necessarily."
    p "But, even if what you're saying is right, why would you interrupt it. Wasn't that what you wanted?"
    scene bd219 with dissolve
    n "I want fun, [p]. I just wanted to be a part of it!"
    scene bd220 with dissolve
    n "I'm not that complicated, really."
    p "You just want to be a part of the fun?"
    scene bd221 with dissolve
    n "Yeah!"
    scene bd222 with dissolve
    n "Think about it. I've been nuzzling up to Kaira for so long. I want to be there when we despoil her~!"
    p "Jesus."
    scene bd223 with dissolve
    n "What~? I stopped you from venting your tensions?"
    n "You could always take it out on me, you know?"
    scene bd224 with dissolve
    n "Have you ever fucked a blonde before?"
    p "Well... actually..."
    scene bd225 with dissolve
    n "A {i}platinum{/i} blonde?"
    p "Well now that you put it that way..."
    p "You definitely deserved to be punished."
    scene bd226 with dissolve
    n "{i}Rawr...{/i}"
    scene bd227 with dissolve
    n "Let's spend this night all to ourselves~"
    # sex
    scene black with fade
    "Nicole and I were used to this routine."
    "I couldn't wait, and she couldn't wait to throw off her clothes either."
    scene bd228 with fade
    $ renpy.pause()
    scene bd229 with dissolve
    $ renpy.pause()
    scene bd230 with dissolve
    $ renpy.pause()
    scene bd231 with dissolve
    $ renpy.pause()
    scene bd232 with dissolve
    $ renpy.pause()
    scene bd233 with dissolve
    $ renpy.pause()
    n "Well, big boy?"
    n "Are you ready for me to jump on you yet?"
    scene bd234 with dissolve
    play music "sounds/kiss.mp3" fadeout 1
    p "The big boy here looks just about ready."
    scene bd235 with dissolve
    n "You think? I think he's quite glad to see me."
    p "I think he is."
    scene bd236 with dissolve
    n "Luckily for him... I'm feeling quite thirsty today~"
    p "Oh god you're so hot."
    p "Christ, what are you waiting for, permission?"
    n "Ask me for it."
    p "Please suck my penis already!"
    n "Happy to oblige~"
    image pv11 = Movie(play="/animations/pv11.webm")
    scene pv11 with dissolve
    $ renpy.pause()
    "Nicole toyed with me, barely touching the tip of my penis with that sweet mouth of hers."
    "The sound of sucking resonated through the room. Nicole wasn't even trying to be discrete."
    n "Mmm~"
    p "Stop teasing me, you little bitch."
    p "Just go and-"
    image pv12 = Movie(play="/animations/pv12.webm")
    scene pv12 with dissolve
    $ renpy.pause()
    "She attacked the whole tip of my penis only, sending me into sensory overdrive."
    p "Ooh Nicole... you..."
    p "Ahh, fuck!"
    "Her tongue swirled around the underside of my tip, causing me to go insane."
    "She was exerting her power over me, in the only way she knew how - pure sexiness."
    p "At this rate, babe, I'll cum before you get to have any fun."
    scene bd237 with dissolve
    "Nicole transitioned away from a blow job, enveloping my throbbing penis between her two breasts."
    n "About to cum? We can't let that happen yet, can we~?"
    n "Looks like I'll have to massage this swelling back down~"
    image pv13 = Movie(play="/animations/pv13.webm")
    scene pv13 with dissolve
    $ renpy.pause()
    p "Oooh!"
    p "You dirty little thing!"
    "Nicole only smiled cheekily, her eyes locked onto mine."
    p "Enjoying yourself, aren't you?"
    ...
    n "That shut you up, didn't it~? Hehe~"
    n "This is the power of horny, female, primal sexuality, [p]. Do you feel it's power?"
    n "Are you about to cum?"
    p "Ah..."
    n "Are you about to-"
    scene bd238 with flash
    $ renpy.pause()
    scene bd239 with flash
    $ renpy.pause()
    scene bd240 with flash
    $ renpy.pause()
    scene bd241 with flash
    $ renpy.pause()
    scene bd242 with flash
    $ renpy.pause()
    scene bd243 with dissolve
    $ renpy.pause()
    scene bd244 with dissolve
    $ renpy.pause()
    scene bd245 with dissolve
    $ renpy.pause()
    scene bd246 with dissolve
    $ renpy.pause()
    scene bd247 with dissolve
    $ renpy.pause()
    scene bd248 with dissolve
    $ renpy.pause()
    scene bd249 with dissolve
    play music "sounds/alchemy.mp3" fadeout 1
    n "Tasty. But you disappoint, [p]."
    n "Who's going to fuck my pussy now?"
    p "Uh, that really drained me. I feel so tired."
    n "Can't keep up?"
    p "Just need to... take a nap..."
    scene bd250 with dissolve
    n "Uh, [p]?"
    scene bd251 with dissolve
    n "Are you alright? [p]!"
    scene bd252 with dissolve
    $ renpy.pause()
