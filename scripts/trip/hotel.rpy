label hotel1:
    ...
    p "Yeah, you mean with the plane trip being quite nice, and the hotel rooms being decent also."
    ...
    p "Err... early morning. Kaira wants to go to the beach or something. We'll need to grab the van then drive over."
