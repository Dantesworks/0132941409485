label cowgirl:
    ...
    an "M-my body!"
    an "Wait, what!! My breasts! What did you do to them!"
    ...
    an "Die."
    p "Hah."
    an "(Any night of this darkness... how long has it been?)"
    ...
    p "Don't misunderstand me. I said it at the start. I don't want to just your wrath."
    ...
    # touch boobs
    an "Ah~!"
    p "All I did was stroke your tits."
    an "This feeling - I..."
    ...
    p "Mister?"
    an "My breasts... they feel so full. But I can't move to massage them."
    ...
    an "My whole body is on fire! Oh thank you for massaging my full breats!"
    ...
    p "Give up. Angelina is no more. You are a cow girl now."
    ...
    p "Your lips have swollen up. Your hips are round and thick."
    ...
    an "My boobs are making me really horny, moo!"
    an "Please fuck me and make me feel good!"
