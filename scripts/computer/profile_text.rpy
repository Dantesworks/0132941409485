...
#         vbox xjustify True size 1800 xalign 0.5 yalign 0.4:
...
#         if kairalvl > 1:
#             vbox xjustify True size 1800 xalign 0.5 yalign 0.6:
...
#         vbox xjustify True size 1800 xalign 0.5 yalign 0.36:
...
#             vbox xjustify True size 1800 xalign 0.5 yalign 0.5:
#                 text "Nicole enjoys visiting [p]'s house in the afternoons, Kaira reveals." justify True size 28
#         if nicolelvl > 1:
#             vbox xjustify True size 1800 xalign 0.5 yalign 0.56:
...
#         vbox xjustify True size 1800 xalign 0.5 yalign 0.365:
...
#         if camillelvl > 0:
#             vbox xjustify True size 1800 xalign 0.5 yalign 0.35:
...
#         if camillelvl > 1:
#             vbox xjustify True size 1800 xalign 0.5 yalign 0.48:
...
#         vbox xjustify True size 1800 xalign 0.5 yalign 0.37:
...
#         if carolinelvl > 1:
#             vbox xjustify True size 1800 xalign 0.5 yalign 0.52:
...
#         vbox xjustify True size 1800 xalign 0.5 yalign 0.345:
