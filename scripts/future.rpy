label future:
    ...
    if nicolelvl == 10:
        ...
        # BJ
        scene white
        image n6 = Movie(play="/animations/n6.webm")
        ...
        "Like now!"
        hide n6
        image n7 = Movie(play="/animations/n7.webm")
        ...
        hide n7
        scene white
        $ renpy.movie_cutscene("animations/n8.webm", loops=0, stop_music=False)
        scene n-99
        n "{i}Pant, pant.{/i}"
        ...
        menu holidaypark:
            ...
            "Time to go." if holidaypark1 and holidaypark2 and holidaypark3:
                ...
                n "I'll play."
                scene n-259 with dissolve
                ## Remove later
                d "This is the end of Nicole's adventures for now."
                d "I hope you enjoyed the story so far!"
                scene black with fade
                call daykeep from _call_daykeep_28
                call daykeep from _call_daykeep_29
                call daykeep from _call_daykeep_30
                $ nicolelvl +=1
                return
