label nicoletalk:
    ...
    if nicolelvl == 8 and day > nicoleday:
        ...
        n "Ah..."
        n "..okay."
        p "Fantastic service here. To think they actually do pancakes. You seemed a bit reluctant there."
        n "I went through with it in the end."
        p "I bet those pancakes are going to be good."
        n "..."
        n "What are you smiling about?"
        p "You know, you're a beautiful woman, Nicole. I'm serious."
        n "Oh I'm flattered."
        p "No really. But it's not just your look. It's your vibe."
        n "Vibe?"
        p "It's the femme fatale."
        n "You're reminding me of my acting days now."
        ...
        n "But my sister was the first. She was all natural and had all the attention."
        n "My... enhancements came later in life."
        "Is Nicole insecure about this?"
        p "Do you still get to meet up with your sister often?"
        ...
        n "But I'm hungry!"
        p "..."
        n "10 minutes? 20 minutes?"
        p "Eh, probably 10 minutes."
        ...
        p "Quick thoughts? Don't forget, this was your idea."
        ...
        n "My father has a holiday park. It's for elites and stuff. Something like a country club?"
        n "He owns so many properties I haven't actually been to this one, so I thoguht we could christen it together."
        ...
        p "You?"
        n "I'm a girl who can't do without some meat, so I'm still... unfulfilled."
        n "Let's go home and fuck~"
        p "If you want it so bad, why wait?"
        p "Strip down and let's go."
        n "Haha, are you crazy? They'll see!"
        p "Lunch time is over, no one should be wandering over here. I'll block their view."
        n "Such a dare devil~"
        p "Hurry up now."
        n "Yes daddy~!"
    scene n-4
